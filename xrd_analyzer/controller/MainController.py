...
from xrd_analyzer import __version__
...
class MainController:
    ...
    def __init__(self, use_settings=True, settings_directory="default", config_file=None):
        """
        :param use_settings: whether to use previously auto saved state
        ...
        if settings_directory == "default":
            self.settings_directory = os.path.join(os.path.expanduser("~"), ".XrdAnalyzer")
        else:
    ...
    def update_title(self):
        ...
        xrd_str = "XRD Analyzer " + __version__

        if img_filename == "" and pattern_filename == "":
            self.widget.setWindowTitle(xrd_str)
            self.widget.integration_widget.img_frame.setWindowTitle(xrd_str)
            return
