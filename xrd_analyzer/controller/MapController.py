...
from xrd_analyzer.model.DioptasModel import DioptasModel
from xrd_analyzer.model.util.calc import convert_units
from xrd_analyzer.widgets.MapWidget import MapWidget
